...
class Preference @Inject constructor(
    ...
    companion object {
        ...
        private const val RING_BELL = "RING_BELL"
    }
    ...
    var isRingBell
        get() = sharedPreferences.getBoolean(RING_BELL, false)
        set(value) {sharedPreferences.edit().putBoolean(RING_BELL,value).apply()}
