...
//    CAMERA(R.string.take_a_selfie, Icons.Default.PhotoCamera),
...
//                    if (isTaken) {
//                        val file1 = ctx.createFileInCache("image_capture_${System.currentTimeMillis()}.jpg")
//                        targetFile.copyTo(file1)
//                        onFileSelected(
//                            BitmapUtils.compressFile(ctx, file1)
//                        )
//                        scope.launch {
//                            sheetState.hide()
//                        }
...
//                    if (imageUri != null) {
//                        onFileSelected(
//                            BitmapUtils.compressFile(
//                                ctx,
//                                ctx.importFileInCache(imageUri)
//                            )
//                        )
//                        scope.launch {
//                            sheetState.hide()
...
//                }
//
//            options.forEach { selectFileFrom ->
//                Row(
//                    Modifier
//                        .fillMaxWidth()
//                        .clickable {
